...
var resetAdmin = function () { return __awaiter(void 0, void 0, void 0, function () {
    var mongoUri, userSchema, User, adminUser, salt, hashedPassword, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                error_1 = _a.sent();
                console.error('Error resetting admin:', error_1);
                process.exit(1);
                return [3 /*break*/, 7];
